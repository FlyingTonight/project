                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="dream">
                                          ...
                                          <a class="read_more" href="Javascript:void(0)">Boshlash</a>
                                          <a class="read_more" href="Javascript:void(0)">Biz bilan Aloqa</a>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="dream_img">
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>Hammasi <span class="blue_light">domain</span>bilan boshlanadi</h2>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="form">
                     <div class="searchbar">
                        <input class="search_input" type="text" name="" placeholder="Domain qidiruv">
                     ...
                     <div class="row">
                        <div class="col-sm-2">
                           <div class="domain-price">
                              <strong>Domain <br> Yiliga</strong>
                           </div>
                        </div>
                        <div class="col-sm-10">
            ...
            <div class="row">
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     ...
                     <a class="read_more" href="hosting.html">Batafsil</a>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
               ...
               <div class="col-md-4">
                  <div id="ho_co" class="order-box_main">
                     <div class="order-box text_align_center">
                        ...
                        <p>STARTING  <span>$7</span> PER MONTH</p>
                     ...
                     <a class="read_more" href="Javascript:void(0)">Hoziroq hariq qiling</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div id="ho_co" class="order-box_main">
                     <div class="order-box text_align_center">
                        ...
                        <p>STARTING  <span>$8</span> PER MONTH</p>
                        <a href="Javascript:void(0)">Personal use</a>
                        <ul class="supp">
                           <li>Unlimited projects</li>
                           <li>24/7 support</li>
            ...
            <div class="row">
               ...
               <div class="col-md-10 offset-md-1">
                  <div class="about_img text_align_center">
                     ...
                     <a class="read_more" href="Javascript:void(0)">Batafsil</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="contact">
         <div class="container">
            <div class="row ">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>Biz bilan <span class="blue_light">Aloqa</span></h2>
                  </div>
               </div>
               <div class="col-md-10 offset-md-1">
                  <form id="request" class="main_form">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <button class="send_btn">Jonatish</button>
                        </div>
                     </div>
                  </form>
               </div>
